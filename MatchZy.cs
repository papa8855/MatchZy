...
namespace MatchZy
{
    ...
    public partial class MatchZy : BasePlugin
    {
        ...
        public override string ModuleVersion => "0.8.15-NoWhitelist"; // 標記為自定義版

        public override string ModuleAuthor => "WD- (Modified for No-Whitelist)";

        public override string ModuleDescription => "A plugin for running and managing CS2 matches without SteamID restrictions!";
        ...
        public bool isWhitelistRequired = false; // 修改點 1: 預設將白名單需求設為 false
        ...
        // --- 修改點 2: 強制所有玩家都被視為在名單內 ---
        public bool IsPlayerInMatch(CCSPlayerController? player)
        {
            return true; // 不管是誰，都放行
        }

        // --- 修改點 3: 讓路人可以根據陣營被判定為 Team1/Team2 ---
        public CsTeam GetPlayerTeam(CCSPlayerController? player)
        {
            ...
            // 優先看 JSON 名單
            if (matchConfig.Team1.Players.ContainsKey(steamId)) return CsTeam.Terrorist;
            if (matchConfig.Team2.Players.ContainsKey(steamId)) return CsTeam.CounterTerrorist;

            // 名單沒人時，按目前陣營判定，這樣路人才能打 .ready
            return player.Team;
        }
        ...
        public override void Load(bool hotReload)
        {
            ...
            RegisterEventHandler<EventPlayerTeam>((@event, info) =>
            {
                ...
                // 修改點 5: 使用自定義的 GetPlayerTeam 來決定隊伍
            ...
            RegisterEventHandler<EventPlayerChat>((@event, info) =>
            {
                ...
                {
                    HandleSpawnCommand(player, messageCommandArg, (byte)CsTeam.Terrorist, "tsspawn");
                }
            ...
            Console.WriteLine($"[{ModuleName} {ModuleVersion} LOADED] Custom MatchZy: Whitelist Disabled");
        }
    }
}
