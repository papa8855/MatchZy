    ...
    public partial class MatchZy : BasePlugin
    {
        ...
        public override void Load(bool hotReload) {
            ...
            commandActions = new Dictionary<string, Action<CCSPlayerController?, CommandInfo?>> {
                { ".ready", OnPlayerReady }, { ".r", OnPlayerReady },
                { ".forceready", OnForceReadyCommandCommand }, { ".unready", OnPlayerUnReady },
                { ".notready", OnPlayerUnReady }, { ".ur", OnPlayerUnReady },
            ...
            RegisterEventHandler<EventCsWinPanelRound>(EventCsWinPanelRoundHandler, HookMode.Pre);
